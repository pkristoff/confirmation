...
feature 'admins/show_visitor.html.erb' do
  ...
  scenario 'edit the visitor home page' do
    ...
    expect_show_visitor(HOME_PARISH_CHANGED_VALUE, HOME_INIT_VALUE, ABOUT_INIT_VALUE, CONTACT_INIT_VALUE,
                        [[:flash_notice, I18n.t('messages.home_parish_updated')]])

    fill_in(I18n.t('label.visitor.home'), with: HOME_CHANGED_VALUE)
    click_button('top-update-home')

    expect_show_visitor(HOME_PARISH_CHANGED_VALUE, HOME_CHANGED_VALUE, ABOUT_INIT_VALUE, CONTACT_INIT_VALUE,
                        [[:flash_notice, I18n.t('messages.home_updated')]])

    fill_in(I18n.t('label.visitor.about'), with: ABOUT_CHANGED_VALUE)
    click_button('top-update-about')

    expect_show_visitor(HOME_PARISH_CHANGED_VALUE, HOME_CHANGED_VALUE, ABOUT_CHANGED_VALUE, CONTACT_INIT_VALUE,
                        [[:flash_notice, I18n.t('messages.about_updated')]])
