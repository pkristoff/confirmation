...
describe ApplicationController do
  ...
  describe 'event_class' do
    ...
    context 'confirmation due_date is set' do
      ...
      let(:confirmation_event_today) { FactoryBot.create(:confirmation_event, the_way_due_date: Time.zone.today, chs_due_date: Time.zone.today) }
      let(:confirmation_event_today_plus_40) { FactoryBot.create(:confirmation_event, the_way_due_date: Time.zone.today + 40, chs_due_date: Time.zone.today + 40) }
      let(:confirmation_event_today_minus_40) { FactoryBot.create(:confirmation_event, the_way_due_date: Time.zone.today - 40, chs_due_date: Time.zone.today - 40) }
      ...
      let(:candidate_event_not_verified_no_due_date) { create_candidate_event(candidate, Time.zone.today, false, confirmation_event_no_due_date) }
      let(:candidate_event_not_verified_today) { create_candidate_event(candidate, Time.zone.today, false, confirmation_event_today) }
      let(:candidate_event_not_verified_today_plus_40) { create_candidate_event(candidate, Time.zone.today, false, confirmation_event_today_plus_40) }
      let(:candidate_event_not_verified_today_minus_40) { create_candidate_event(candidate, Time.zone.today, false, confirmation_event_today_minus_40) }

      let(:candidate_event_completed_no_due_date) { create_candidate_event(candidate, Time.zone.today, true, confirmation_event_no_due_date) }
      let(:candidate_event_completed_today) { create_candidate_event(candidate, Time.zone.today, true, confirmation_event_today) }
      let(:candidate_event_completed_today_plus_40) { create_candidate_event(candidate, Time.zone.today, true, confirmation_event_today_plus_40) }
      let(:candidate_event_completed_today_minus_40) { create_candidate_event(candidate, Time.zone.today, true, confirmation_event_today_minus_40) }
