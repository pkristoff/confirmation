...
describe 'visitors/cand_account_confirmation.html.erb' do
  it 'candidate is confirmed.' do
    ...
    expect(rendered).to have_selector('div[id=confirmed] p', text: 'The next step is to change your password. You should have gotten another e-mail explaining how to do this.')
  end
