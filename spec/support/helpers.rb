...
def expect_have_field_text(rendered_or_page, field_name, field_id, value, disabled, pre_selector = '')
  expect(rendered_or_page).to have_field(field_name, disabled: disabled, count: 1, id: field_id)
...
def expect_address_fields(rendered_or_page, values, disabled, form_txt_address = '')
  expect_have_field_text(rendered_or_page,
                         I18n.t('label.baptismal_certificate.baptismal_certificate.church_address.street_1'),
                         'candidate_baptismal_certificate_attributes_church_address_attributes_street_1',
                         values[:street1],
                         disabled,
                         form_txt_address)
  expect_have_field_text(rendered_or_page,
                         I18n.t('label.baptismal_certificate.baptismal_certificate.church_address.street_2'),
                         'candidate_baptismal_certificate_attributes_church_address_attributes_street_2',
                         values[:street2],
                         disabled,
                         form_txt_address)
  expect_have_field_text(rendered_or_page,
                         I18n.t('label.baptismal_certificate.baptismal_certificate.church_address.city'),
                         'candidate_baptismal_certificate_attributes_church_address_attributes_city',
                         values[:city],
                         disabled,
                         form_txt_address)
  expect_have_field_text(rendered_or_page,
                         I18n.t('label.baptismal_certificate.baptismal_certificate.church_address.state'),
                         'candidate_baptismal_certificate_attributes_church_address_attributes_state',
                         values[:state],
                         disabled,
                         form_txt_address)
  expect_have_field_text(rendered_or_page,
                         I18n.t('label.baptismal_certificate.baptismal_certificate.church_address.zip_code'),
                         'candidate_baptismal_certificate_attributes_church_address_attributes_zip_code',
                         values[:zip_code],
                         disabled,
                         form_txt_address)
end
