...
describe 'layouts/_side_bar.html.erb' do
  ...
  before(:each) do
    ...
    @admin_export_link_names_in_order = [
      ...
      [I18n.t('views.nav.export_baptized_at_home_parish_title', home_parish: I18n.t('home_parish.nick_name')), '/export_lists/baptism'],
      [I18n.t('views.nav.export_sponsor_at_home_parish_title', home_parish: I18n.t('home_parish.nick_name')), '/export_lists/sponsor'],
